<h1 align="center"> ASAP: Statistics Aligning Simulation and Real-World Physics for
...
ASAP with Statistics v1

```bash
python humanoidverse/train_agent.py \
+simulator=isaacgym \
+exp=motion_statisticsv1 \
+domain_rand=NO_domain_rand \
+rewards=motion_tracking/reward_motion_tracking_statisticsv1 \
+robot=g1/g1_29dof_anneal_23dof \
+terrain=terrain_locomotion_plane \
+obs=motion_tracking/deepmimic_a2c_nolinvel_LARGEnoise_history \
num_envs=4096 \
